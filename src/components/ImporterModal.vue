<template>
  <div v-show="showImporterModal" class="fixed z-10 inset-0 overflow-y-auto scrollbar" aria-labelledby="modal-title" role="dialog" x-cloak aria-modal="true">
	<div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
	  ...
	  <div @mousedown.outside="showImporterModal = false" class="relative inline-block bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 align-middle sm:max-w-xl md:max-w-2xl lg:max-w-4xl w-full"
		   v-show="showImporterModal"
		   x-transition:enter="ease-out duration-300"
					...
					<div class="inline-block min-w-full py-2 align-middle">
					  <div class="overflow-hidden shadow-sm ring-1 ring-black ring-opacity-5">
						<table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
						  ...
						  <div v-for="source in stagedSources">
					...
					<div class="inline-block min-w-full py-2 align-middle">
					  <div class="overflow-hidden shadow-sm ring-1 ring-black ring-opacity-5">
						<table class="min-w-full divide-y divide-gray-300 dark:divide-gray-600">
						  ...
						  <div v-for="monster in stagedMonsters.slice(0, 6)">
							<tr class="odd:bg-gray-50 even:bg-gray-100 dark:odd:bg-gray-700 dark:even:bg-gray-600">
